  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col gap-4 flex-1">
        ...
        {/* Stat strip with vertical dividers */}
        <div className="grid grid-cols-3 border-t border-cw-border pt-3">
          {/* W / L */}
          <div className="pr-3">
            <div className="text-[9px] font-semibold uppercase tracking-widest text-cw-text-tertiary mb-1">
              W&nbsp;/&nbsp;L
            </div>
            <div className="font-mono text-xs font-bold text-cw-text-primary tabular-nums">
...
// ─── AnimatedPodium (Podium layout wrapper) ───────────────────────────────────
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {first && (
          <TopWarriorCard
            user={first}
            position={1}
            trophyColor="var(--color-tier-gold)"
            delay={0}
          />
        )}
        ...
        {second && (
          <TopWarriorCard
            user={second}
            position={2}
            trophyColor="var(--color-tier-silver)"
            delay={100}
          />
        )}
        ...
        {third && (
          <TopWarriorCard
            user={third}
            position={3}
            trophyColor="var(--color-tier-bronze)"
            delay={200}
          />
        )}
      </div>
